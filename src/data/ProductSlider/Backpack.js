export const backpackPorduct = {
    ...
    products: [
        ...
        {
            id: `c2c9dcfb-b281-4ca5-9d58-026aaae6fadf`,
            price: `29.99`,
            path: 'backpack',
            brand: 'Matein',
            information: [
                {
                    ...
                    description: '18 x 12 x 7.8 inches'
                },
                {
                    title: 'Item Weight',
                    description: '1.56 pounds'
                },
                {
                    title: 'Department',
                    description: 'unisex-adult'
                },
                {
                    title: 'Manufacturer',
                    description: 'YoTwo'
        ...
        {
            id: `f9563a13-d877-4250-a1a6-d6676afbedfb`,
            price: `42.98`,
            path: 'backpack',
            brand: 'Modoker',
            information: [
                {
                    title: 'Product Dimensions',
                    description: '18 x 7 x 16.5 inches'
                },
                {
                    title: 'Item Weight',
                    description: '2.09 pounds'
                },
                {
                    title: 'Department',
                    description: 'unisex-adult'
        ...
        {
            id: `9e8c0e27-a057-4c26-bd26-d49e5b225e97`,
            price: `33.99`,
            path: 'backpack',
            brand: 'Cyureay',
            information: [
                {
                    title: 'Product Dimensions',
                    description: '16.1*12.2*4.7'
                },
                {
                    title: 'Item Weight',
                    description: 'about 1 pound'
                },
                {
                    title: 'Luggage Strap',
                    description: 'true'
        ...
        {
            id: `4e7683c4-f10f-4585-bc5a-7859adf98e5d`,
            price: `39.99`,
            path: 'backpack',
            brand: 'Vgcub',
            information: [
                {
                    ...
                    description: '16.81 x 9.88 x 5.39 inches'
                },
                {
                    title: 'Item Weight',
                    description: '2.48 pounds'
                },
                {
                    title: 'Department',
                    description: 'unisex-adult'
        ...
        {
            id: `f59fc33d-c972-4cfc-83d4-2e7ac664681c`,
            price: `27.99`,
            path: 'backpack',
            brand: 'Monsdle',
            information: [
                {
                    title: 'Product Dimensions',
                    description: '12.8 x 7.8 x 18.8 inches'
                },
                {
                    title: 'Item Weight',
                    description: '1.68 pounds'
                },
                {
                    title: 'Department',
                    description: 'unisex-adult'
        ...
        {
            id: `b4a245bd-1968-4296-9331-8c5b4d6b8999`,
            price: `39.99`,
            path: 'backpack',
            brand: 'Carhartt',
            information: [
                {
                    title: 'Product Dimensions',
                    description: '2 x 16 x 19.75 inches'
                },
                {
                    title: 'Item Weight',
        ...
        {
            id: `a55cd221-8af0-43b7-bbfd-9f344cf19cbd`,
            price: `21.59`,
            path: 'backpack',
            brand: 'Supacool',
            information: [
                {
                    title: 'Product Dimensions',
                    description: '5.1 x 12.6 x 16.9 inches'
                },
                {
                    title: 'Item Weight',
                    description: '1.28 pounds'
                },
                {
                    title: 'Department',
                    description: 'unisex-adult'
